          ...
          <div className="relative z-10 flex h-full w-full max-w-3xl flex-col justify-end px-5 pb-28 sm:px-8 md:px-12 md:pb-36">
            ...
            <div className="pointer-events-auto mt-7 flex flex-wrap items-center gap-3">
              <button
                ...
                className="liquid-pill group/play inline-flex h-12 items-center gap-2.5 rounded-xl px-7 text-[15px] font-bold transition-all duration-[420ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-0.5 hover:shadow-[0_14px_34px_-18px_rgba(0,0,0,0.6)] hover:brightness-[1.03] active:translate-y-0 active:scale-[0.98] will-change-transform"
              >
                <Play className="h-4 w-4 fill-current transition-transform duration-[420ms] ease-[cubic-bezier(0.22,1,0.36,1)] group-hover/play:translate-x-0.5" />
                Play
              </button>
