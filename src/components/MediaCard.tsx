    ...
    <div className={`group relative isolate shrink-0 overflow-visible ${width}`}>
      ...
      >
        ...
        >
          ...
          <div className="pointer-events-none absolute inset-x-0 bottom-0 flex items-end justify-between px-3 pb-3 opacity-0 transition-all duration-500 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0">
            <span className="text-xs font-medium text-white/90 drop-shadow">{media.year}</span>
            {media.rating > 0 && (
