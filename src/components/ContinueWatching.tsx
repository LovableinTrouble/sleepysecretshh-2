          ...
          return (
            <div key={`${it.mediaId}-${it.mediaType}`} className="group relative w-64 shrink-0 md:w-72">
              ...
              <button
                ...
                className="pointer-events-auto absolute right-2 top-2 z-30 flex h-8 w-8 items-center justify-center rounded-full bg-black/75 text-white opacity-100 ring-1 ring-white/20 shadow-lg backdrop-blur transition hover:bg-destructive hover:scale-110 active:scale-95"
              >
