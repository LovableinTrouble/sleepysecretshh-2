...
const seasonOf = (
  ...
  count: number,
  base: string,
): { number: number; episodes: Episode[] } => ({
  number: n,
  episodes: Array.from({ length: count }, (_, i) =>
    ep(
      i + 1,
      `Episode ${i + 1}`,
      "A turning point reshapes the path forward as alliances are tested and secrets surface.",
      base,
    ),
  ),
});
...
export const CATALOG: Media[] = [
  {
    ...
    runtime: "1h 42m",
    overview:
      "After a shipwreck, an intelligent robot called Roz is stranded on an uninhabited island. To survive, she must adapt and form a relationship with the local wildlife.",
  ...
  },
  {
    ...
    runtime: "2h 28m",
    overview:
      "Years after witnessing the death of the revered hero Maximus, Lucius is forced to enter the Colosseum after his home is conquered by the tyrannical Emperors who now lead Rome.",
  ...
  },
  {
    ...
    runtime: "1h 40m",
    overview:
      "After receiving an unexpected call from her wayfinding ancestors, Moana must journey to the far seas of Oceania for an adventure unlike anything she's ever faced.",
  ...
  },
  {
    ...
    runtime: "2h 3m",
    overview:
      "After Santa Claus is kidnapped, the North Pole's Head of Security must team up with the world's most infamous bounty hunter to save Christmas.",
  ...
  // TV
  {
    ...
    seasons: [
      seasonOf(1, 10, "/etj8E2o0Bud0HkONVQPjyCkIvpv.jpg"),
      seasonOf(2, 8, "/etj8E2o0Bud0HkONVQPjyCkIvpv.jpg"),
    ],
  },
  {
    id: 76479,
    ...
    genres: ["Action", "Sci-Fi"],
    seasons: [
      seasonOf(1, 8, "/mGVrXeIjyecj6TKmwPVpHlscEmw.jpg"),
      seasonOf(2, 8, "/mGVrXeIjyecj6TKmwPVpHlscEmw.jpg"),
      seasonOf(3, 8, "/mGVrXeIjyecj6TKmwPVpHlscEmw.jpg"),
      seasonOf(4, 8, "/mGVrXeIjyecj6TKmwPVpHlscEmw.jpg"),
    ],
  },
  {
    id: 100088,
    ...
    genres: ["Drama", "Sci-Fi"],
    seasons: [
      seasonOf(1, 9, "/uDgy6hyPd82kOHh6I95FLtLnj6p.jpg"),
      seasonOf(2, 7, "/uDgy6hyPd82kOHh6I95FLtLnj6p.jpg"),
    ],
  },
  {
    id: 1399,
  ...
  },
  {
    ...
    rating: 8.9,
    overview:
      "When Walter White, a chemistry teacher, is diagnosed with Stage III cancer, he turns to a life of crime, producing and selling methamphetamine.",
  ...
  },
  {
    ...
    rating: 8.2,
    overview:
      "Ichigo Kurosaki gains soul reaper powers and takes on the duty of defending humans from evil spirits.",
...
export function similarTo(media: Media, count = 6) {
  return CATALOG.filter((m) => m.id !== media.id)
    .map((m) => ({
      m,
      score:
        m.genres.filter((g) => media.genres.includes(g)).length + (m.type === media.type ? 1 : 0),
    }))
